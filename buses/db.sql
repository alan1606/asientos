...
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  PRIMARY KEY (`id`),
	CONSTRAINT fk_estadi_pais FOREIGN KEY (`id_pais`) REFERENCES `pais` (`id`)
...
(2203, 81, 'Región de Arica y Parinacota');
  ...
  create table destino(
    ...
    constraint uq_ciudad unique(ciudad, id_estado),
...
create table cliente (
    ...
    tipo enum("CLIENTE", "AGENCIA") not null,
    constraint pk_id primary key (id)
);
...
create table asiento(
    ...
    constraint pk_id primary key(id),
    constraint uq_numero_id_viaje unique (numero,id_viaje),
