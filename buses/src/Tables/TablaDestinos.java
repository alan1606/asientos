...
public class TablaDestinos {
    ...
    public void cargarTabla(JTable tabla, ArrayList<DestinoVO> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            destino = list.get(i);
            fila[0] = destino.getId();
            fila[1] = destino.getCiudad();
            fila[2] = destino.getIdEstado();
            dt.addRow(fila);
        }
        tabla.setModel(dt);
